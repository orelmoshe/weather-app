...
const SearchInput = ({ selectedItem, results, filterFunction, renderComponent,	image,	textPlaceholder,	showDropDownArrow,	containerHeight,	containerWidth,	showBorderLabel,	borderLabelText,	displayList,	rightImage,	hideBorder,	onRightImageClick }: SearchInputProps) => {
